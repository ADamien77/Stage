...
/**
 * searchform.php
 * Remplace le formulaire de recherche par défaut de WP.
 */
?>
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
  <label for="search-field" class="screen-reader-text"><?php esc_html_e( 'Rechercher:', 'monthemeperso' ); ?></label>
  ...
  <div class="search-field-wrap">
    <input
      ...
      />
    <button type="submit" class="search-submit" aria-label="<?php esc_attr_e( 'Rechercher', 'monthemeperso' ); ?>">
