...
<body>
  ...
  <section class="qui_sommes_nous">
    ...
    <div class="image">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/qui_sommes_nous.png" alt="Qui sommes-nous" />
    </div>
  </section>
  ...
  <section class="notre_histoire">
    <div class="contenu">
      ...
      <p>
        ...
        fermentum sed magna sit amet, dapibus rutrum enim. Sed laoreet posuere
        tortor eu tincidunt. Quisque facilisis nulla sed risus fringilla
        tempus. Duis pretium viverra orci, nec mollis metus lacinia id. Integer
        vitae dapibus nibh. Ut dictum varius metus in aliquam. Phasellus ut
        condimentum urna, ac bibendum turpis. Proin sollicitudin metus id
        turpis posuere pulvinar. Proin tristique ante quis leo malesuada
        fermentum eget eget ligula. Fusce accumsan vitae nibh vel volutpat.
        Suspendisse dictum, orci ut ultrices pulvinar, est mauris condimentum
        purus, at accumsan libero leo eget dui.
      </p>
    </div>
  </section>
